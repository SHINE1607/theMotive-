...
/***/ "./node_modules/date-diff/date-diff.js":
/*!*********************************************!*\
  !*** ./node_modules/date-diff/date-diff.js ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _index = __webpack_require__(/*! ../index */ \"./src/js/index.js\");\n\nvar _getAge = __webpack_require__(/*! get-age */ \"./node_modules/get-age/index.js\");\n\nvar _getAge2 = _interopRequireDefault(_getAge);\n\nvar _dateDiff = __webpack_require__(/*! date-diff */ \"./node_modules/date-diff/date-diff.js\");\n\nvar _dateDiff2 = _interopRequireDefault(_dateDiff);\n\nvar _timer = __webpack_require__(/*! timer */ \"./node_modules/timer/timer.js\");\n\nvar _timer2 = _interopRequireDefault(_timer);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Time = function () {\n    function Time() {\n        _classCallCheck(this, Time);\n\n        this.oldTime = {};\n        this.newTime = {};\n        this.age = {};\n        this.month = ['January, February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];\n    }\n\n    _createClass(Time, [{\n        key: 'getOldTime',\n        value: function getOldTime() {\n\n            // this.oldTime.year = prompt('Enter the year of birth');\n            // this.oldTime.month = prompt('Enter the month of birth');\n            // this.oldTime.day = prompt('Enter the day of birth');\n            //test\n            this.oldTime.year = 1997;\n            this.oldTime.month = 7;\n            this.oldTime.day = 16;\n        }\n    }, {\n        key: 'getNewTime',\n        value: function getNewTime() {\n            var d = new Date();\n            this.newTime.year = d.getFullYear();\n            this.newTime.month = d.getMonth();\n            this.newTime.day = d.getDate();\n        }\n    }, {\n        key: 'getAge',\n        value: function getAge() {\n            var date1 = new Date(this.newTime.year, this.newTime.month, this.newTime.day);\n            var date2 = new Date(this.oldTime.year, this.oldTime.month, this.oldTime.day);\n\n            var diff = new _dateDiff2.default(date1, date2);\n\n            this.age.years = Math.floor(diff.years());\n            this.age.months = this.monthCalc(Math.floor(diff.months()));\n            this.age.days = this.dayCalc(diff.days());\n            this.age.hours = Math.floor(Math.random() * (+24 - +0)) + +0;\n            this.age.minutes = Math.floor(Math.random() * (+60 - +0)) + +0;\n            this.secondCalc();\n        }\n    }, {\n        key: 'monthCalc',\n        value: function monthCalc(totMonths) {\n            return (totMonths - (12 - this.oldTime.month)) % 12;\n        }\n    }, {\n        key: 'dayCalc',\n        value: function dayCalc(totDays) {\n            return totDays % 30;\n        }\n    }, {\n        key: 'hourCalc',\n        value: function hourCalc(hours) {\n            hours = hours + 1;\n            if (this.age.hours == 24) {\n                this.age.hours = 0;\n                this.dayCalc(this.age.days);\n            }\n            this.age.hours = hours;\n        }\n    }, {\n        key: 'minuteCalc',\n        value: function minuteCalc(minutes) {\n            minutes = minutes + 1;\n            if (this.age.minutes == 60) {\n                this.age.minutes = 0;\n                this.hourCalc(this.age.hours);\n            }\n            this.age.minutes = minutes;\n        }\n    }, {\n        key: 'secondCalc',\n        value: function secondCalc() {\n            var _this = this;\n\n            // let seconds = Math.floor(Math.random() * (+60 - +1)) + +1; \n            this.age.seconds = 55;\n            // const el = document.querySelector('.seconds');\n\n            var cancel = setInterval(function () {\n                _this.age.seconds += 1;\n                if (_this.age.seconds == 60) {\n                    _this.age.seconds = 0;\n                    _this.minuteCalc(_this.age.minutes);\n                }\n                // el.innerText = `${seconds}`;\n            }, 1000);\n        }\n    }]);\n\n    return Time;\n}();\n\nexports.default = Time;\n\n//# sourceURL=webpack:///./src/js/models/time.js?");
